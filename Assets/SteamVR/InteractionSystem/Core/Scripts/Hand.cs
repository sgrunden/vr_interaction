...
namespace Valve.VR.InteractionSystem
{
    ...
    public class Hand : MonoBehaviour
    {
        ...
        private Vector3 positionOffset = new Vector3(0, 0, 0.1f);
        ...
        public void AttachObject(GameObject objectToAttach, GrabTypes grabbedWithType, AttachmentFlags flags = defaultAttachmentFlags, Transform attachmentOffset = null)
        {
            ...
            if (attachedObject.interactable != null)
            {
                ...
                attachedObject.handAttachmentPointTransform.localPosition = positionOffset;
                attachedObject.handAttachmentPointTransform.localRotation = netRotation;
